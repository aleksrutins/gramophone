    ...
    return (
        <div className="flex flex-col rounded shadow shadow-green-400 bg-green-100 border border-green-500 p-3 text-green-900">
            <div className="flex flex-row items-center">
                ...
                <span className="font-bold pl-1">Challenge!</span>
            </div>

            <p>{text}</p>
            <a className="font-bold no-underline cursor-pointer text-green-900" onClick={() => setExpanded(!expanded)}>{expanded ? "Hide" : "Show"} Answer</a>
            {expanded ? children : <></>}
        </div>
    )
}